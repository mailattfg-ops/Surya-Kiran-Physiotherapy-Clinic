            ...
            <div className="relative w-full max-w-[1400px]">
              ...
              <div className="flex justify-center items-center gap-8">
                ...
                <motion.div
                  ...
                  className="hidden md:block shrink-0 w-96 h-96 bg-white rounded-xl shadow-lg overflow-hidden transform scale-90"
                >
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.5 }}
                  className="shrink-0 w-[80vw] sm:w-96 h-auto min-h-[24rem] bg-white rounded-xl shadow-xl overflow-hidden z-10"
                >
                  <div className="h-48 overflow-hidden">
                    <img
              ...
              <button
                onClick={handlePrev}
                className="absolute left-4 top-1/2 -translate-y-1/2 z-20 w-8 h-8 lg:w-12 lg:h-12 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-gray-100 transition-colors"
              >
              ...
              <button
                onClick={handleNext}
                className="absolute right-4 top-1/2 -translate-y-1/2 z-20 w-8 h-8 lg:w-12 lg:h-12 bg-white rounded-full shadow-lg flex items-center justify-center hover:bg-gray-100 transition-colors"
              >
                <svg className="w-4 h-4 lg:w-6 lg:h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
